...
class LoginServiceRepo : KoinComponent {
    ...
    private var serviceAPIHelper= ServiceAPIHelper(LoginServiceInterface::class.java, LoginMockServiceImpl::class.java, networkConfig.getServiceType(), networkConfig.getBaseURL())
