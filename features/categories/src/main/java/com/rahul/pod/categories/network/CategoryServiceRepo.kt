...
class CategoryServiceRepo:KoinComponent {
    ...
    private val serviceAPIHelper: CategoryServiceApiHelper<CategoryServiceInterface,CategoryMockServiceImpl> by inject { parametersOf(networkConfig.getServiceType(), networkConfig.getBaseURL()) }
